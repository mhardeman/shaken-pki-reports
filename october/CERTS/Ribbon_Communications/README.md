...
- 22 potential certificate URLs were requested for retrieval
- 22 candidate certificates were parsed from the potential certificate URLs
- 0 certificates in the candidate corpus were excluded because they are duplicates
- 5 certificates in the candidate corpus were excluded because they were not valid during the target validity period
- 0 certificates in the candidate corpus were excluded because they did not chain to program trust anchors
- 17 valid certificates were tested against the remaining rules
- 1.71 issues on average found in valid but non-compliant certificates
...
- 5.88% of valid certificates are too old to be assessed against currently enforced expectations
- 323 days is the average remaining validity of the valid certificates
- 365 days is the average initial validity of the valid certificates
...
- 0.00% of valid certificates contain one or more Warning level issue
- 0.00% of valid certificates contain one or more Notice level issue
- 66.67% of valid certificates are too old to be assessed against currently enforced expectations
- 6386 days is the average remaining validity of the valid certificates
- 5966 days is the average initial validity of the valid certificates
