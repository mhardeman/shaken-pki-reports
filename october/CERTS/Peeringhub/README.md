...
- 79 potential certificate URLs were requested for retrieval
- 79 candidate certificates were parsed from the potential certificate URLs
- 7 certificates in the candidate corpus were excluded because they are duplicates
- 11 certificates in the candidate corpus were excluded because they were not valid during the target validity period
- 0 certificates in the candidate corpus were excluded because they did not chain to program trust anchors
- 61 valid certificates were tested against the remaining rules
- 1.00 issues on average found in valid but non-compliant certificates
- 21.31% of valid certificates contain one or more Error level issue
...
- 3.28% of valid certificates are too old to be assessed against currently enforced expectations
- 121 days is the average remaining validity of the valid certificates
- 126 days is the average initial validity of the valid certificates
- 2.10 average number of unexpired certificates per OCN observed
...
- 0 certificates in the candidate corpus were excluded because they did not chain to program trust anchors
- 2 valid certificates were tested against the remaining rules
- 1.00 issues on average found in valid but non-compliant certificates
...
- 5541 days is the average remaining validity of the valid certificates
- 5475 days is the average initial validity of the valid certificates
