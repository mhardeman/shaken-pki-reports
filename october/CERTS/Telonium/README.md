...
- 29 potential certificate URLs were requested for retrieval
- 29 candidate certificates were parsed from the potential certificate URLs
- 3 certificates in the candidate corpus were excluded because they are duplicates
...
- 23 valid certificates were tested against the remaining rules
- 1.00 issues on average found in valid but non-compliant certificates
- 17.39% of valid certificates contain one or more Error level issue
...
- 424 days is the average remaining validity of the valid certificates
- 442 days is the average initial validity of the valid certificates
...
- 0 certificates in the candidate corpus were excluded because they did not chain to program trust anchors
- 5 valid certificates were tested against the remaining rules
- 4.00 issues on average found in valid but non-compliant certificates
- 60.00% of valid certificates contain one or more Error level issue
- 0.00% of valid certificates contain one or more Warning level issue
- 0.00% of valid certificates contain one or more Notice level issue
- 0.00% of valid certificates are too old to be assessed against currently enforced expectations
- 4207 days is the average remaining validity of the valid certificates
- 4309 days is the average initial validity of the valid certificates
