...
- 68 repository URLs were included in the corpus being tested
- 0 repository URLs in the corpus were skipped because they were duplicated
- 68 repository URLs being tested against the remaining rules
- 3.12 issues on average found in non-compliant certificate repository URLs
...
|-----------|------|--------|
| 68 | [e_atis_cache_header](ISSUES/e_atis_cache_header/README.md) | ATIS-1000074 |
| 38 | [e_http_status_200](ISSUES/e_http_status_200/README.md) | HTTP |
| 68 | [w_atis_content_type](ISSUES/w_atis_content_type/README.md) | ATIS-1000080 |
| 38 | [w_atis_pem_certificate_chain](ISSUES/w_atis_pem_certificate_chain/README.md) | ATIS-1000080 |
